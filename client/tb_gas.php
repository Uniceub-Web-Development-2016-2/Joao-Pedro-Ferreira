...
<script type="text/javascript">
  ...
  $.ajax({
            type:"GET",
            url: "http://localhost/servidor/joaoLoko/verValor/?idt_combustivel=1",
            dataType:'json',
            error:function(erro){
                alert(erro);
            },
    ...
    <div class="col-md-10">
      ...
      <form class="form-signin"  action="page.php">
         <br>
                ...
                <center> <button class="btn btn-danger" type="submit" onclick="submitSignIn()">Voltar</button></center> </form>
