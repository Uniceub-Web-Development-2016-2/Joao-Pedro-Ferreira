<?php
 ...
 if($_POST["valor"] != null && $_POST["diesel"] != null && $_POST["posto"] != null)
 {
 	$login_array = array('var_valor' => $_POST["valor"], 'cod_combustivel' =>$_POST["diesel"], 'cod_posto' =>$_POST["posto"]);
 
 	$url = "http://localhost/servidor/tb_usuario/diesel";
